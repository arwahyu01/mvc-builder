...
$columTypes = [
    "id", "string", "text", "foreignId", "foreignUuid", "boolean", "json", "longText", "enum", "float", "binary", "char", "bigIncrements", "bigInteger", "dateTimeTz", "dateTime", "date",
...
return [
    ...
    'table' => "{ data: '{{ field }}' , 'defaultContent':''},", // table column template (optional)
    'view' => $inputElements,
    'column_types' => $columTypes,
];
